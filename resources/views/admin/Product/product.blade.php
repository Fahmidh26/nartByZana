...
<div class="row"> <!-- start 2nd row  -->
			<div class="col-md-4">
				<div class="form-group">
					<h6>Select Sub-Category<span class="text-danger">*</span></h6>
					<div class="controls">
...
<div class="row"> <!-- start 4th row  -->
			...
			<div class="col-md-4">
				<div class="form-group">
					<h6>Main Thumbnail <span class="text-danger">*</span></h6>
					<div class="controls">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
		 ...
		 <!-- end col md 4 -->
			...
			<div class="col-md-4">
				<div class="form-group">
					<h6>Multiple Image <span class="text-danger">*</span></h6>
					<div class="controls">
...
<div class="row"> <!-- start 7th row  -->
	...
	<div class="col-md-4">			
			...
			{{-- <div class="form-group">
				<h6>Features<span class="text-danger">*</span></h6>
				<div class="controls">
		 <input type="text" name="short_descp" class="form-control" value="red,Black,Amet" data-role="tagsinput" required="">
		 @error('short_descp') 
		 <span class="text-danger">{{ $message }}</span>
		 @enderror
				  </div>
...
<div class="row"> <!-- start 8th row  -->
		...
		<div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp" id="textarea" class="form-control" required ></textarea>     
	 		 </div>
		</div>
