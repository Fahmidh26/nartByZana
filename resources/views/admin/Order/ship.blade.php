	...
	<div class="col-12">	
		...
		<div class="row"> <!-- start 1st row  -->
			...
			<div class="col-md-4">
				...
				<hr>
				<div class="form-group">
					<h5>Delivery Company Name <span class="text-danger">*</span></h5>
					<div class="controls">
			 <input type="text" name="delivery_company" class="form-control" required="">
...
<div class="row"> <!-- start 2nd row  -->
			...
			<div class="col-md-4">	
				<div class="form-group">
					<h5>Delivery Fee <span class="text-danger">*</span></h5>
					<div class="controls">
...
<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Ship Product">
						</div>
					</form>
