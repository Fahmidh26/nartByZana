...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/images/zawad_logo.jpeg') }}">

    <title>NART BY ZANA</title>
...
<body style="background: linear-gradient(rgb(58, 1, 48), rgb(201, 29, 253))" class="hold-transition theme-primary bg-gradient-primary">
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">NART BY ZANA</h2>
							<p class="text-white-50">ADMIN SIGN UP</p>							
						</div>
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
								...
								<div class="form-group">
								  ...
								  <div class="row">
									...
									<div class="col-12 text-center">
									  <button type="submit" class="btn btn-outline-light btn-rounded mt-10">SIGN UP</button>
									</div>
									<!-- /.col -->
								  </div>
							</form>													
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?<a href="{{route('login')}}" class="text-white-50 ml-5"> SIGN IN</a></p>
							</div>
						</div>
					</div>
				</div>
